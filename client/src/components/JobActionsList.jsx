  ...
  return (
    <Flex flexDirection={"column"} w={["100%", "80%"]} h={"300px"} border={"2px"} borderColor={"gray.200"} borderRadius={"2xl"}>
      <Flex w={"full"} px={3} h={"40px"} bg={"blue.300"} borderTopRadius={"inherit"}
        ...
        <Text fontSize={["sm","xl"]}>Job Actions</Text>
        
      </Flex>
      <Flex w={"full"} bg={'gray.100'}  h={"25px"}  
        justifyContent={"space-between"} alignItems={"center"} fontWeight={"semibold"}>
        <Flex w={"200px"} justifyContent={"center"} ><Text fontSize={["xs","md"]}>User</Text></Flex>
        <Flex w={"200px"} justifyContent={"center"}><Text fontSize={["xs","md"]}>Action Type</Text></Flex>
        <Flex w={"400px"} justifyContent={"center"}><Text fontSize={["xs","md"]}>Action Details</Text></Flex>
        <Flex w={"200px"} justifyContent={"center"}><Text fontSize={["xs","md"]}>Timestamp</Text></Flex>
      </Flex>
